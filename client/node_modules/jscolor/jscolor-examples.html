...
<body>
	...
	<script>
		...
		jscolor.presets.default = {
			palette: [
				'#000000', '#7d7d7d', '#870014', '#ec1c23', '#ff7e26', '#fef100', '#22b14b', '#00a1e7', '#3f47cc',
				'#a349a4',
				'#ffffff', '#c3c3c3', '#b87957', '#feaec9', '#ffc80d', '#eee3af', '#b5e61d', '#99d9ea', '#7092be',
				'#c8bfe7',
			],
			//paletteCols: 12,
	...
	Color: <button class="butt" data-jscolor="{valueElement:'#val4', alphaElement:'#alp4'}"></button>
	...
	<p>
		...
		<input onChange="update(this.jscolor, '#pr3')" onInput="update(this.jscolor, '#pr4')" value="CCFFAA"
	...
	<script>
		document.getElementsByClassName('butt')[0].addEventListener("click", function (e) {console.log('hello');})
